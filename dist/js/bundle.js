...
var optiscroll = createCommonjsModule(function (module) {
/*!
...
var shake$1 = createCommonjsModule(function (module) {
/*
 * Author: Alex Gibson
...
var flipCard = function () { flipped = true; vcard.classList.add('flip'); };
var unflipCard = function () { flipped = false; vcard.classList.remove('flip'); };
...
var scrollInstances = Array.from(document.querySelectorAll('.optiscroll')).map(function (area) {
  return new optiscroll(area);
});

var shakeInstance = new shake$1({
  threshold: 15,
  timeout: 1000
});
shakeInstance.start();
...
Array.from(document.querySelectorAll('.toggle-flip')).map(function (element) {
  element.addEventListener('click', toggleFlip);
  return element;
});

setTimeout(function () {
  Array.from(document.querySelectorAll('.delayed')).map(function (element) {
